...
export class PopulateObservableCollection<T, TKey, B extends boolean, K extends string> extends ObservableCollection<T, TKey> {
    constructor(
        _db: Dexie,
        _table: Table<T, TKey>,
        ...
        Object.getOwnPropertyNames(ObservableCollection.prototype).forEach(name => {

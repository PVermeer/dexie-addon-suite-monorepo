...
declare const DexieBooleanNullIndexAddon: DexieBooleanNullIndexAddon;
...
describe('dexie-boolean-null-index-addon dexie.spec', () => {
    ...
    describe('Dexie', () => {
        ...
        describe('HTML script tag', () => {
            beforeAll(async () => {
                await new Promise<void>(resolve => {
                    ...
                    await new Promise<void>(resolve => {
                        ...
                        scriptAddon.src = '/base/dist/dexie-boolean-null-index-addon.min.js';
            ...
            it('should load DexieNullIndexeAddon', () => {
                expect(DexieBooleanNullIndexAddon).toBeTruthy();
                expect(DexieBooleanNullIndexAddon.booleanNullIndex).toBeTruthy();
            });

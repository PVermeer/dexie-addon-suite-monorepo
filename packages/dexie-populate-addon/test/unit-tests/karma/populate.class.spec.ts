...
import { Club, databasesPositive, Friend, mockClubs, mockFriends, mockGroups, mockHairColors, mockStyles, mockThemes, Style, Theme } from '../../mocks/mocks.spec';
...
describe('Populate class', () => {
    ...
    beforeEach(async () => {
        ...
        [hasFriendIds, clubIds, themeIds, groupIds, styleIds, hairColorIds] = await Promise.all([
    ...
    it('should populate', async () => {
        ...
        expect(getFriendPop.memberOf[1]!.theme!.style instanceof Style).toBeTrue();
    });

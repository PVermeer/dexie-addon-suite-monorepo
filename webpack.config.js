...
const bundles = (env) => {
  ...
  const umd = {
    ...
    target: "web",
    externals: [
      ...configLib.dependenciesMapped,
      ...configLib.peerDependenciesMapped,
    ],
    plugins: [
      new BundleAnalyzerPlugin({
        ...
        reportFilename: path.resolve(
          packagePath,
          "reports",
          "umd-webpack-report.html"
        ),
        generateStatsFile: true,
        statsFilename: path.resolve(
          packagePath,
          "reports",
          "umd-webpack-stats.json"
        ),
        statsOptions: {
          source: false,
          usedExports: true,
  ...
  const umdMini = {
    ...
    target: "web",
    externals: [...configLib.peerDependenciesMappedUmdImports],
    plugins: [
      new BundleAnalyzerPlugin({
        analyzerMode: "static",
        openAnalyzer: false,
        reportFilename: path.resolve(
          packagePath,
          "reports",
          "mini-umd-webpack-report.html"
        ),
        generateStatsFile: true,
        statsFilename: path.resolve(
          packagePath,
          "reports",
          "mini-umd-webpack-stats.json"
        ),
        statsOptions: {
          source: false,
          usedExports: true,
